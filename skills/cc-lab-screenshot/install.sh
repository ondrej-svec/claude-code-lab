#!/usr/bin/env bash
# Install the cc-lab-screenshot skill into ~/.claude/skills/cc-lab-screenshot
#
# Usage:
...
echo ""
echo "  To use: open Claude Code in the lab repo and say 'shoot the voice chapter visuals'"
