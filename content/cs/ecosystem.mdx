...
**Forkování.** Subagent se `subagent_type: "fork"` teď zdědí celou konverzaci i prompt cache místo toho, aby startoval od nuly — sáhni po něm, když subagent potřebuje vše, na čem jste se s Claude už shodli, ne jen stručné zadání.
