...
**Forkování.** Subagent spuštěný s&nbsp;`subagent_type: "fork"` zdědí celou rodičovskou konverzaci i&nbsp;její prompt cache, místo aby začínal od nuly — hodí se, když subagent potřebuje všechno, o&nbsp;čem už byla řeč, ne jen ohraničené zadání.
