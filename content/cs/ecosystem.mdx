...
**Vnořené projektové skilly.** Skilly v podadresářích `.claude/skills/` se načítají automaticky, jakmile Claude pracuje se soubory v té části projektu. Při konfliktu jmen se vnořený skill zobrazí jako `<dir>:<name>`, takže oba zůstanou dostupné.
