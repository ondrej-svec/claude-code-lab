...
**Fork typ.** Subagent se `subagent_type: "fork"` teď zdědí celou konverzaci i prompt cache místo startu od nuly — levnější delegování, když subagent potřebuje všechno, co už máš načtené v kontextu.
