...
**Zmiň session přes @.** Napiš do promptu `@` a&nbsp;název session a&nbsp;Claude ji osloví přes `SendMessage` rovnou — nemusíš volání nástroje psát sám.
...
**Forkování.** Spusť subagenta s&nbsp;`subagent_type: "fork"` a&nbsp;zdědí celou konverzaci i&nbsp;prompt cache místo studeného startu — hodí se, když subagent potřebuje všechno, co už máš rozjednané, ne jen shrnutí.
