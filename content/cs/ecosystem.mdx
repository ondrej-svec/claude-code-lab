...
**Vnoření.** Subagenti si ve výchozím stavu už nespouští vlastní subagenty — nastav `CLAUDE_CODE_MAX_SUBAGENT_SPAWN_DEPTH`, jestli chceš povolit hlubší vnoření. Fan-out, který se dřív řetězil sám od prvního subagenta, teď potřebuje tenhle opt-in.
