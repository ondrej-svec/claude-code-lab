...
**Fork dědí kontext.** Subagent spuštěný s&nbsp;`subagent_type: "fork"` — ve výchozím stavu zapnutý v&nbsp;interaktivních session, vypnutý pod `-p` a&nbsp;v&nbsp;Agent SDK — nezačíná od nuly. Zdědí celou dosavadní konverzaci i&nbsp;prompt cache. Sáhni po něm, když subagent potřebuje všechno, co už v&nbsp;konverzaci padlo; na ohraničený, dobře popsaný úkol je pořád lepší volbou čerstvý, nezaforkovaný subagent.
