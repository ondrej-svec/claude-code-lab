...
**Vnoření.** Subagenti si teď ve výchozím stavu spouští vlastní subagenty až do hloubky 3 (dřív to byla 1) — nastav `CLAUDE_CODE_MAX_SUBAGENT_SPAWN_DEPTH=1`, jestli chceš zpátky starý default bez vnoření. Fan-out, který dřív potřeboval ruční opt-in, se teď do téhle hloubky řetězí sám.
