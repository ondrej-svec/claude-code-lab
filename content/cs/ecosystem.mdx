...
**GitLab marketplace funguje taky.** Holá URL repa na `gitlab.com` — včetně vnořených subgroups — se teď klonuje stejně jako `github.com` URL; když se klonování nepovede, chybová hláška pojmenuje tvůj skutečný git host, ne rovnou GitHub.
...
**Forkování.** Subagent typu `subagent_type: "fork"` zdědí celou konverzaci i prompt cache místo aby startoval od nuly — má k dispozici všechno, co už se probíralo, ne jen stručné zadání.
