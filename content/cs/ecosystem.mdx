...
Marketplace pluginů už nejsou jen na GitHubu. Holá URL repa na `gitlab.com` — i&nbsp;s&nbsp;vnořenými subgroups — se teď klonuje stejně jako `github.com` URL. Když klonování selže na autentizaci, hláška pojmenuje tvůj skutečný git host místo aby předpokládala GitHub.
...
**Forkování.** Subagent `subagent_type: "fork"` je teď ve výchozím stavu zapnutý — zdědí celou konverzaci i&nbsp;prompt cache místo startu od nuly. Levnější a&nbsp;rychlejší, kdykoliv subagent potřebuje všechno, co jsi už probral.
