...
**Forknutý subagent zdědí všechno.** `subagent_type: "fork"` subagent — teď zapnutý defaultně — zdědí celou konverzaci i prompt cache, místo aby začínal od nuly. Sáhni po něm, když subagent potřebuje kontext celého rozhovoru, ne jen vymezené zadání.
