...
**Fork dědí kontext.** Subagent spuštěný s&nbsp;`subagent_type: "fork"` — ve výchozím stavu zapnutý — nezačíná od nuly. Zdědí celou dosavadní konverzaci i&nbsp;prompt cache. Sáhni po něm, když subagent potřebuje všechno, co už v konverzaci padlo; na ohraničený, dobře popsaný úkol je pořád lepší volba čerstvý, nezaforkovaný subagent.
