...
**Forking běží ve výchozím stavu.** Subagent spuštěný s `subagent_type: "fork"` zdědí celou konverzaci i&nbsp;prompt cache místo studeného startu — hodí se, když subagent potřebuje všechno, co už máš rozjednané, ne jen ohraničenou instrukci.
