...
**Skládání.** `/skill-a /skill-b do XYZ` načte všechny úvodní skilly (až 5). Kombinuj playbooks v jednom volání, když úkol zasahuje víc domén naráz.
...
Subagenti teď ve výchozím stavu jedou na pozadí — Claude pracuje dál, zatímco jedou, a dostane oznámení, až jsou hotovi. Background agenti spuštění z `claude agents` do worktree jdou ještě dál: jakmile je kódová práce hotová, sami commitnou, pushnou a otevřou draft PR. Žádné dotazování.
