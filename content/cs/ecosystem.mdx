...
**Forkování je ve výchozím stavu zapnuté.** Subagent s `subagent_type: "fork"` teď zdědí celou konverzaci i prompt cache místo studeného startu. Levnější kontext, rychlejší rozjezd — pro subagenta, který má navázat přesně tam, kde jsi skončil.
