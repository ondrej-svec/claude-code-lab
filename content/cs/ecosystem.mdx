...
**Vnoření.** Subagenti teď ve výchozím stavu spouští vlastní subagenty až do tří úrovní — fan-out se zase řetězí sám od sebe. Nastav `CLAUDE_CODE_MAX_SUBAGENT_SPAWN_DEPTH=1`, jestli to chceš vrátit na jednu úroveň.
