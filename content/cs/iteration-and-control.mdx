...
- **`/clear`** — nová konverzace, ta stará se zaarchivuje (dá se obnovit přes `/resume` nebo `/rewind`). Použij, když přehodíš do jiné části codebase nebo konverzace má 30+ kol a drifftuje.
