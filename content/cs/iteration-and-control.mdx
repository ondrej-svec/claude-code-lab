...
1. **Manual** — Claude se ptá před každou editací nebo spuštěním nástroje. To je výchozí chování. (`--permission-mode manual` a `"defaultMode": "manual"` jsou přijímány; `default` zůstává platný alias.)
