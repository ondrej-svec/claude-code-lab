...
1. **Manual** — Claude se ptá před každou editací nebo spuštěním nástroje. (Dřívější název byl „default", stále funguje. V patičce se zobrazí šedý odznak ⏸, když je tenhle mód aktivní.)
