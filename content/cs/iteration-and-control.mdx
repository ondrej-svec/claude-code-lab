...
1. **Ask permissions (Manual)** — Claude se ptá před každou editací nebo spuštěním nástroje. Výchozí. V&nbsp;CLI, `--help`, VS Code a JetBrains se mu teď říká „Manual"; `default` zůstává funkční.
