...
Výjimka v accept edits režimu: konfigurační soubory shellu (`.zshenv`, `.bash_login`) a konfigurace build nástrojů (`.npmrc`, `.bazelrc`, `.devcontainer/`) se pořád ptají — tyhle soubory můžou vést k nechtěnému spuštění příkazů.
</Callout>
