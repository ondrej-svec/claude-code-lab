...
- **`/clear`** — nová konverzace, ta stará se zaarchivuje (dá se obnovit přes `/resume`). `/rewind` teď umí obnovit konverzaci i do bodu před `/clear`. Použij `/clear`, když přehodíš do jiné části codebase nebo konverzace má 30+ kol a driftuje.
