...
1. **Manual** — Claude se ptá před každou editací nebo spuštěním nástroje. Výchozí režim. V `--permission-mode` a `settings.json` se dá použít i jako `default`.
