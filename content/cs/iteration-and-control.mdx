...
2. **Accept edits** — Claude edituje volně, diff si prohlédneš až po. Výjimka: konfigurační soubory build nástrojů (`.npmrc`, `.yarnrc*`, `bunfig.toml`, `.bazelrc`, `.pre-commit-config.yaml`, `.devcontainer/` a podobné) se vždy zeptají — umožňují spouštění kódu.
