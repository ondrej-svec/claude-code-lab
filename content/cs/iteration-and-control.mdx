...
1. **Manual** — Claude se ptá před každou editací nebo spuštěním nástroje. Výchozí režim; `--permission-mode manual` a `"defaultMode": "manual"` obojí funguje. Šedý ⏸ v patičce pak potvrdí, že jsi v manuálním režimu.
