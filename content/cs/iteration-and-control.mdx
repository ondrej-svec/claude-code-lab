...
1. **Manual** — Claude se ptá před každou editací nebo spuštěním nástroje. (Výchozí. Přijímá se taky jako `--permission-mode manual` nebo `"defaultMode": "manual"` v nastavení.)
