...
1. **Manual** — Claude se ptá před každou editací nebo spuštěním nástroje. (`--permission-mode manual` v&nbsp;CLI. Šedý odznak ⏸ ve statusu dá vždy vědět, jaký režim je aktivní.)
