...
1. **Manual** — Claude se ptá před každou editací nebo spuštěním nástroje. (`--permission-mode manual`; starší `default` se pořád přijímá.)
