...
Claude Sonnet 5 — teď výchozí model — přichází s nativním kontextovým oknem 1M tokenů. Rozpočet je větší; návyky pořád platí. 1M okno se na reálném codebase zaplní rychleji, než by ses nadál, a `/compact` vyjde levněji než narazit do zdi uprostřed práce.
</Callout>
