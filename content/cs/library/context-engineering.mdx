...
**Aktivní kontext** je to, co je v aktuální konverzaci. Token-tlustý, drahé to držet, dokonale čerstvé. Každé kolo žije tady. Session s API klíčem nebo u cloud providerů si tu vrstvu můžou držet teplou déle: `promptCacheTtl` ji na hlavní konverzaci natáhne až na hodinu, `subagentPromptCacheTtl` na subagenty — výchozně pět minut.
