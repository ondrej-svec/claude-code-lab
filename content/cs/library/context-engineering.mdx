...
**Uživatelé API klíčů a cloudových providerů mají na tuhle vrstvu vlastní páku.** `promptCacheTtl` drží prompt cache hlavní konverzace naživu hodinu místo výchozích pěti minut; `subagentPromptCacheTtl` řídí totéž pro volání subagentů, která zůstávají na pěti minutách. Delší TTL na aktivním kontextu znamená míň plnocenných znovunačtení, když se na chvíli odpojíš a vrátíš — přímá úspora na vrstvě, která stojí nejvíc.
