...
Když to funguje: tvůj `CLAUDE.md` je *tvůj* — ne starter, ne ten, co navrhl `/init`, ale ten tvarovaný podle toho, jak s kódem fakt pracuješ. Praxe v další kapitole používá plan mode na přidání další funkce.
