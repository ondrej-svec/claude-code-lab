...
Když tě Claude opraví, zeptej se sám sebe: *je to jednorázovka, nebo konvence?* Pokud konvence, přidej to do `CLAUDE.md`. V příští konverzaci už stejná chyba nepřijde.
