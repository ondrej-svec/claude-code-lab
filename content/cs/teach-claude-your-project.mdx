...
<Diagram caption="Všechny soubory se při startu session zřetězí. Při konfliktu vyhrává ten pozdější v řetězu.">{`flowchart TD
    M["Managed politika"] --> U["Uživatel · ~/.claude/CLAUDE.md"]
    U --> P["Projekt · ./CLAUDE.md"]
    P --> L["Lokální · CLAUDE.local.md"]`}</Diagram>
