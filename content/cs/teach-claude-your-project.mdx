...
<Diagram chart={`flowchart TD
    M[Managed politika<br/>enterprise admin] --> U
    U["Uživatel<br/>~/.claude/CLAUDE.md"] --> P
    P["Projekt<br/>./CLAUDE.md"] --> L
    L["Lokální<br/>CLAUDE.local.md · gitignorované"]`} caption="Všechny soubory se při startu session zřetězí. Při konfliktu vyhrává ten pozdější v řetězu." />
