...
[Wispr Flow](https://wisprflow.ai) je oblíbená volba — tichý, podržíš zkratku, naťuká přepis do té aplikace, kterou máš v popředí. Bezplatná verze ti vystačí na většinu denní práce.

[Super Whisper](https://superwhisper.com) běží Whisper lokálně. Stejný princip se zkratkou. Sáhni po něm, když ti soukromí znamená víc než hladší UX od Wispr.

[macOS Diktování](https://support.apple.com/cs-cz/guide/mac-help/mh40583/mac) je varianta bez instalace (výchozí zkratka `Fn Fn`). Hodí se na to, abys ověřil, že hardware funguje, než za něco zaplatíš; jako každodenní nástroj to není.
