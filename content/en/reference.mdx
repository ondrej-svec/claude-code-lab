...
| `/code-review [effort]` | Report correctness bugs at a chosen effort level (e.g., `/code-review high`). Pass `--comment` to post findings as inline GitHub PR comments. Replaces `/simplify`. |
