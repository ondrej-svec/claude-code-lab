...
| `/rewind` | Checkpoint menu — restore code, conversation, or both to an earlier state. Same as double-Esc. Now reaches back through `/clear` — the checkpoint menu shows states from before a cleared conversation. |
