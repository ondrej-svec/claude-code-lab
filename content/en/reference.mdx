...
**Output style.** Claude Code ships a built-in "Concise" style — Claude leads with results and skips preamble and narration, without cutting corners on the work itself. Switch to it under Output style in `/config` when you want less narration between prompts.
