...
| `/doctor`, `/checkup` | Full setup checkup — surfaces and can fix config conflicts and missing setup; also proposes trimming `CLAUDE.md` files Claude could derive from the codebase. |
