...
| `/fast` | Toggle fast mode. Applies to Opus 5 — now the default Opus model, 1M context, $10/$50 per Mtok at fast-mode rates — and Opus 4.8; Opus 4.7 no longer qualifies. |
...
| `sandbox.network.strictAllowlist: true` | Denies non-allowlisted hosts for sandboxed commands outright — no prompt, just blocked. |
