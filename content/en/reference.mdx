...
**Default model.** As of v2.1.197, Claude Sonnet 5 is the session default — 1M-token native context window, promotional pricing of $2/$10 per Mtok through August 31. Switch with `/model` to change models.
