...
| `/config [key=value]` | Open the settings UI, or set a setting inline: e.g. `/config thinking=false`. Works in interactive, `-p`, and Remote Control. `/config --help` lists every shorthand key. |
