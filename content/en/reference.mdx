...
| `/rewind` | Checkpoint menu — restore code, conversation, or both to an earlier state. Same as double-Esc. Now reaches back before a `/clear` — restores conversations you already cleared. |
