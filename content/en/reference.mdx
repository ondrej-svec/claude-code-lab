...
| `/doctor` | Full setup checkup — diagnoses and fixes issues. `/checkup` is its alias. |

### Workflow

| Command | What it does |
|---|---|
| `/agents` | View background sessions (running, blocked, done). To create an agent, ask Claude or edit `.claude/agents/<name>.md` directly. |
