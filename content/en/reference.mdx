...
**Output style.** A built-in `Concise` style is now available under Output style in `/config` — Claude leads with results and skips preamble and narration, doing the work just as thoroughly.
