...
**Screenshot pending capture.** Will show: Claude desktop app with the microphone button active mid-dictation, transcribed text *"Add a /usage command"* visible in the prompt area. Caption: *Press mic. Speak. Watch the prompt fill.*
</Callout>
...
<Callout variant="note">
**Screenshot pending capture.** Will show: Claude desktop app with a pasted error-screenshot thumbnail in the prompt area and the question *"What's wrong here?"* typed below. Caption: *Drag a screenshot in. Claude sees what you see.*
</Callout>
