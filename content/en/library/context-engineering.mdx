...
Claude Sonnet 5 — now the default model — ships with a native 1M-token context window. The budget is bigger; the habits still pay. A 1M window fills faster than you'd expect on a real codebase, and `/compact` costs far less than hitting the wall mid-task.
</Callout>
