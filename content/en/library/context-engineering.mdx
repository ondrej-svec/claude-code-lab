...
One number worth knowing if you're on Sonnet 5's 1M-token window: auto-compact now waits until roughly 967K tokens instead of about 934K, using the full window before it kicks in. More runway before `/compact` becomes involuntary — the four moves above are still how you get ahead of it on purpose.
