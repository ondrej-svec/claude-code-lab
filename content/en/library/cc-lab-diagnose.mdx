...
[Chapter 5 — Ecosystem](/en/lab/ecosystem) covers skills and plugins generally, including how to install ones like this. The diagnostic is one example of the "tool installed via marketplace" shape.
