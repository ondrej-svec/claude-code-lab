...
<Screenshot
  ...
  alt="Five-step compounding loop — brainstorm, plan, work, review, compound — with accumulated artifacts at the center"
  caption="Each pass leaves documents — plans, diffs, reviews, skills — that the next brainstorm and plan draw on."
/>
...
## Background agents and draft PRs

Since v2.1.198, background agents launched from `claude agents` that finish code work in a worktree now commit, push, and open a draft PR automatically — instead of stopping to ask.
