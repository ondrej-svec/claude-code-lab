...
One exception in accept edits mode: shell startup files and build-tool configs (`.npmrc`, `.bazelrc`, `.devcontainer/`) still prompt — these files can lead to unintended command execution.
</Callout>
