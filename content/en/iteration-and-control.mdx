...
1. **Manual** — Claude asks before each edit or tool run. (Formerly called "default"; `--permission-mode manual` and `"defaultMode": "manual"` are both accepted. A grey ⏸ badge in the footer shows when this mode is active.)
