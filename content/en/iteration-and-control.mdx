...
1. **Ask permissions (Manual)** — Claude asks before each edit or tool run. Default. The label "Manual" now appears across the CLI, `--help`, VS Code, and JetBrains; `default` is still accepted.
