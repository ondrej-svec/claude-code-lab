...
1. **Manual** — Claude asks before each edit or tool run. (Default. Also accepted as `--permission-mode manual` and `"defaultMode": "manual"` in settings.)
