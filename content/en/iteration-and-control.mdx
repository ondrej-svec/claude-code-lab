...
One exception in accept edits mode: shell startup files (`.zshenv`, `.bash_login`) and build-tool configs (`.npmrc`, `.bazelrc`, `.devcontainer/`) still prompt — these files can lead to unintended command execution.
</Callout>
