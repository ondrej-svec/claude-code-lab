...
<Screenshot
  ...
  alt="A dark Rosé Pine diagram: terminal cards for planning, diffs, permissions, security, and automation connected around a central verified coding loop."
  caption="The shift is not blind trust. It is replacing constant diff-watching with tests, permissions, reviews, and automation that catch mistakes for you."
/>
