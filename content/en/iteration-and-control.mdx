...
1. **Manual** — Claude asks before each edit or tool run. This is the default. (`--permission-mode manual` and `"defaultMode": "manual"` are accepted; `default` remains a valid alias.)
