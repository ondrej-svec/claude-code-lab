...
1. **Manual** — Claude asks before each edit or tool run. Default mode; `--permission-mode manual` and `"defaultMode": "manual"` both work. A grey ⏸ appears in the footer when Manual is active.
