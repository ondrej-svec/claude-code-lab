...
**Nesting.** Subagents can spawn their own subagents up to three levels deep by default — fan-out chains automatically again. Set `CLAUDE_CODE_MAX_SUBAGENT_SPAWN_DEPTH=1` to cap it back to a single level.
