...
Once sessions spread across repos and machines, `claude agents` is the one-stop list: running, blocked on you, done. It's in Research Preview — run it and see if it changes how you juggle work.
