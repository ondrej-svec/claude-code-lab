...
**Nesting.** Sub-agents can spawn their own sub-agents, up to 5 levels deep. A coordinator agent can delegate to workers without routing everything through the main conversation.
