...
<Diagram chart={`flowchart TD
    M[Managed policy<br/>enterprise admin] --> U
    U["User<br/>~/.claude/CLAUDE.md"] --> P
    P["Project<br/>./CLAUDE.md"] --> L
    L["Local<br/>CLAUDE.local.md · gitignored"]`} caption="All files concatenate at session start. Later in the chain wins on conflict." />
