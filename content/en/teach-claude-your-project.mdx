...
When it works: your `CLAUDE.md` is *yours* — not the starter, not the one `/init` proposed, the one shaped by how you actually work. The next chapter's practice uses plan mode to add a second feature.
